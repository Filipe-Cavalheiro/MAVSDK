...
int main(int argc, char** argv){
    ...
    while (!telemetry.health_all_ok()) {
        ...
        bool is_gyrometer_calibration_ok = telemetry.health().is_gyrometer_calibration_ok;
        bool is_accelerometer_calibration_ok = telemetry.health().is_accelerometer_calibration_ok;
        bool is_magnetometer_calibration_ok = telemetry.health().is_magnetometer_calibration_ok;
        bool is_local_position_ok = telemetry.health().is_local_position_ok;
        bool is_global_position_ok = telemetry.health().is_global_position_ok;
        bool is_home_position_ok = telemetry.health().is_home_position_ok;
        bool is_armable = telemetry.health().is_armable;
